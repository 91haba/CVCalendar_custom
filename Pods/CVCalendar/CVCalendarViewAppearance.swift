...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelPresentWeekdayInitallyBold: Bool? = false
    ...
    public var dayLabelPresentWeekdayBoldFont: UIFont? = UIFont(name: "Avenir", size: 18)
    public var dayLabelPresentWeekdayHighlightedFont: UIFont? =
        UIFont(name: "Avenir-Heavy", size: 18)
    public var dayLabelPresentWeekdaySelectedFont: UIFont? = UIFont(name: "Avenir", size: 18)
    public var dayLabelWeekdayHighlightedFont: UIFont? = UIFont(name: "Avenir", size: 18)
    public var dayLabelWeekdaySelectedFont: UIFont? = UIFont(name: "Avenir", size: 18)

    /// Default text color.
    public var dayLabelWeekdayDisabledColor: UIColor? = .gray
    public var dayLabelWeekdayInTextColor: UIColor? = .colorFromCode(0x6d6d6d)
    public var dayLabelWeekdayOutTextColor: UIColor? = .white
    public var dayLabelWeekdayHighlightedTextColor: UIColor? = .white
    public var dayLabelWeekdaySelectedTextColor: UIColor? = .colorFromCode(0x5a99ff)
    public var dayLabelPresentWeekdayTextColor: UIColor? = .colorFromCode(0x6d6d6d)
    public var dayLabelPresentWeekdayHighlightedTextColor: UIColor? = .colorFromCode(0xffc900)
    public var dayLabelPresentWeekdaySelectedTextColor: UIColor? = .colorFromCode(0x6d6d6d)

    /// Default text size.
    public var dayLabelWeekdayTextSize: CGFloat? = 16
    public var dayLabelWeekdayHighlightedTextSize: CGFloat? = 18
    ...
    public var dayLabelPresentWeekdayHighlightedBackgroundColor: UIColor? = .colorFromCode(0xffc900)
    public var dayLabelPresentWeekdayHighlightedBackgroundAlpha: CGFloat? = 0.8

    /// Default selected state background & alpha.
    public var dayLabelWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0xffc900)
    public var dayLabelWeekdaySelectedBackgroundAlpha: CGFloat? = 0.9
